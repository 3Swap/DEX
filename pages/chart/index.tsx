...
export default function ChartComponent({}: Props): ReactElement {
  ...
  const getETHKlineBinanceAPI5Min = () => {
    axios
      .get(
        `${process.env.BINANCE_API}klines?symbol=${
      ...
      .then((res: any) => {
        const filterList = res.data.map((data: any) => {
          ...
          return {
            name: customDate,
            pv: parseInt(data[1]),
            amt: new Date(data[0] + 3600000).toUTCString().split(' ')[4].substring(0, 5)
          };
        });
      ...
      .then((res: any) => {
        const filterList = res.data.map((data: any) => {
          ...
          return {
            name: customDate,
            pv: parseInt(data[1]),
            amt: new Date(data[0] + 3600000).toUTCString().split(',')[0]
          };
        });
      ...
      .then((res: any) => {
        const filterList = res.data.map((data: any) => {
          ...
          return {
            name: customDate,
            pv: parseInt(data[1]),
            amt: new Date(data[0] + 3600000).toUTCString().split(',')[1].substring(1, 8)
          };
        });
      ...
      .then((res: any) => {
        const filterList = res.data.map((data: any) => {
          ...
          return {
            name: customDate,
            pv: parseInt(data[1]),
            amt: new Date(data[0] + 3600000).toUTCString().split(',')[1].substring(1, 12).substring(6)
          };
        });
      ...
      .then((res: any) => {
        const filterList = res.data.map((data: any) => {
          ...
          return {
            ...
            pv: parseInt(data[1]),
            amt:
              new Date(data[0] + 3600000).toUTCString().split(',')[1].substring(1, 7) +
              ' ' +
              new Date(data[0] + 3600000).toUTCString().substring(14, 16)
          };
        });
      ...
      .then((res: any) => {
        const filterList = res.data.map((data: any) => {
          ...
          return {
            name: customDate,
            pv: parseInt(data[1]),
            amt: new Date(data[0] + 3600000).toUTCString().substring(12, 16)
          };
        });
  ...
  return (
    <ChartContainer>
      ...
      <Chart
        ...
        oneDayGraph={getETHKlineBinanceAPI5Min}
        sevenDayGraph={getETHKlineBinanceAPI1Hr}
        oneMonthGraph={oneMonthGraph}
        oneYearGraph={oneYearPlot}
        maxGraph={getETHKlineBinanceAPI1Month}
        tabId={tabId}
        setTabId={setTabId}
        value="5932070"
        data={chartData}
