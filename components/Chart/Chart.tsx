...
const Chart = ({tabId,setTabId,data,oneDayGraph,sevenDayGraph,oneMonthGraph,oneYearGraph,changeIn24h,setSelectedPair,selectedPair}: any) => {
    ...
    <ChartArea>
        ...
        <ChartAndButtonDiv>
            <ChartPrice>
                    <div className="cont">
                        ...
                        <ChartDetailText style={changeIn24h.indexOf("-")==-1?{ color: '#00C142', marginRight:'10px' }:{color:'red',marginRight:'10px'}}>{changeIn24h!="9999999"?changeIn24h:'Loading....'}   </ChartDetailText>
                    </div>
          ...
          <ButtonGroup>
              <TabBtn isActive={tabId == 0} onClick={() => {oneDayGraph();;setTabId(0)}}>24H</TabBtn>
              <TabBtn isActive={tabId == 1} onClick={() => {sevenDayGraph();setTabId(1)}}>1W</TabBtn>
              <TabBtn isActive={tabId == 2} onClick={() => {oneMonthGraph();setTabId(2)}}>1M</TabBtn>
              <TabBtn isActive={tabId == 3} onClick={() => {oneYearGraph();setTabId(3)}}>1Y</TabBtn>
            </ButtonGroup>
      ...
      <ResponsiveContainer className='responsive-container'>
         ...
         >
          ...
          <XAxis dataKey="amt" interval={tabId==2?50:tabId==1?24:tabId==3?45:tabId==4?12:50} tick={true} />
          <Tooltip content={<CustomTooltip changeIn24h={changeIn24h} setCurrSymbolPrice={setCurrSymbolPrice}/>}/>
          {/* <Tooltip content={<CustomTooltip changeIn24h={changeIn24h} setCurrSymbolPrice={setCurrSymbolPrice}/>}/> */}
          <Area type="monotone" dataKey="pv" strokeWidth="3" stroke="#27AE60" fillOpacity={1} fill="url(#colorPv)" />
        </AreaChart>
      </ResponsiveContainer>
    </ChartArea>
        )
